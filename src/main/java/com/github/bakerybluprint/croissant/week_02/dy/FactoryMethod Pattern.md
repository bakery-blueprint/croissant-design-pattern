...
### 장점
- 팩토리 메소드 패턴을 사용하면 클래스간의 결합도(클래스의 변경이 있을 때 다른 클래스에 미치는 영향도)를 낮출 수 있음
- 팩토리 메소드 패턴을 사용하는 경우 직접 객체를 생성해 사용하는 것을 방지하고 서브 클래스에 위임함으로써 보다 효율적인 코드 제어를 할 수 있고 의존성을 제거함. -> 결함도 낮춤
