package com.github.bakerybluprint.croissant.week_02.sh;

import com.github.bakerybluprint.croissant.week_02.sh.customer.Customer;
import com.github.bakerybluprint.croissant.week_02.sh.order.InitOrderImpl;
import com.github.bakerybluprint.croissant.week_02.sh.order.InitOrderInterface;
import com.github.bakerybluprint.croissant.week_02.sh.payment.CreditCard;
import com.github.bakerybluprint.croissant.week_02.sh.payment.PayManager;
...
public class ShopMain {
    public static void main(String[] args) {
        ...
        //주문가능고객 판단
        if (!"E".equals(initResult.get("status"))) {
            log.info(initResult.get("message"));
            return;
        }
